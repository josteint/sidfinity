"""Command-line entry point for the HunterPatrol extract pipeline.

Usage:
    python -m pipelines.hunter_patrol.extract                   # alias for `cli`
    python -m pipelines.hunter_patrol.extract.cli               # explicit
    python -m pipelines.hunter_patrol.extract.cli 0,1,2         # all three music subtunes
    python -m pipelines.hunter_patrol.extract.cli -v 0          # subtune 0, debug-level logs
