/-
Named constants used by BattleOfBritain.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. BattleOfBritain uses 1 (vs Commando's 2) because BattleOfBritain
