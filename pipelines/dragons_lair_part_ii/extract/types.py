"""Dataclasses for DragonsLairPartIi's extracted (T, instruments, score) representation.

Mirrors Commando's shape with one DragonsLairPartIi-specific addition: each instrument
...
class Instrument:
    ...
    vibrato_scale: int = 0
    has_bit0: bool = False
    has_skydive: bool = False  # DragonsLairPartIi extension: fx_flags bit 1
