/-
Named constants used by DragonsLairPartIi.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. DragonsLairPartIi uses 1 (vs Commando's 2) because DragonsLairPartIi
