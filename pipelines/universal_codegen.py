...
def emit_sid(usf: UsfFile, usf_dir: str | None = None) -> bytes:
    ...
    # All companion-strain USFs (henrys, bowden, yes_tune, clever,
    # companion) now go through `pipelines.composer`. If they reach
    # here, the composer rejected the USF for some other reason —
