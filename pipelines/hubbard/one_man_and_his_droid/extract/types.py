"""Dataclasses for OneManAndHisDroid's extracted (T, instruments, score) representation.

Mirrors Commando's shape with one OneManAndHisDroid-specific addition: each instrument
...
class Instrument:
    ...
    vibrato_scale: int = 0
    has_bit0: bool = False
    has_skydive: bool = False  # OneManAndHisDroid extension: fx_flags bit 1
...
class Voice:
    ...
    loop: int = -1
    stop: bool = False          # orderlist ended at $FE (song-end), not $FF
