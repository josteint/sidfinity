...
from pipelines.hubbard.one_man_and_his_droid.extract.sfx import extract_sfx
...
SID = os.path.join(ROOT, 'hvsc85', 'MUSICIANS', 'H', 'Hubbard_Rob', 'One_Man_and_his_Droid.sid')
