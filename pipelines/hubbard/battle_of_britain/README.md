...
| Tests | ✅ `pytest pipelines/hubbard/battle_of_britain/tests/` (6 passing) |
...
Mirrors Commando — see `pipelines/hubbard/commando/README.md` for the layout
...
```bash
python3 -m pipelines.hubbard.battle_of_britain.extract.emit_usf
```
...
```bash
pytest pipelines/hubbard/battle_of_britain/tests/
```
...
- Build artefacts land in `pipelines/hubbard/battle_of_britain/build/`.
