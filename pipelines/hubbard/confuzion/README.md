...
| Build / run | `lake build sidgen_confuzion` → `pipelines/hubbard/confuzion/build/confuzion.sid` |
...
`pipelines/hubbard/confuzion/codegen/Confuzion/Codegen.lean`'s `generateSID`
...
python3 -m pipelines.hubbard.confuzion.extract.emit_usf

# Build and run the codegen:
source src/env.sh
lake build sidgen_confuzion
./.lake/build/bin/sidgen_confuzion          # writes pipelines/hubbard/confuzion/build/confuzion.sid
