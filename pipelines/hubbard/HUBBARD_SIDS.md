...
- Generated by `deprecated/gt2_grading/docs/build_hubbard_catalog.py` (combines PSID header parsing,
  `tools/sidid`, and `pipelines/hubbard/commando/extract/decompile.py`). Re-run when the
