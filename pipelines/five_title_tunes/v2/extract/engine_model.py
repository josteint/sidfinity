...
Everything else mirrors `pipelines.chimera.extract.engine_model`.
"""
...
from pipelines.chimera.extract.types import (
...
def extract(
    ...
    from pipelines.chimera.extract.decompile import decompile
