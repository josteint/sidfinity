"""Dataclasses for FiveTitleTunes's extracted (T, instruments, score) representation.

Mirrors Commando's shape with one FiveTitleTunes-specific addition: each instrument
...
class Instrument:
    ...
    vibrato_scale: int = 0
    has_bit0: bool = False
    has_skydive: bool = False  # FiveTitleTunes extension: fx_flags bit 1
