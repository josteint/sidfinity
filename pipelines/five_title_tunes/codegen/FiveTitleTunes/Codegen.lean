...
def generateSID (song : USFSong) (debug : Bool := false) : Bytes := Id.run do
  ...
  cb := cb.label "v_pwhi"
  cb := cb.emitData [0, 0, 0]
  -- pulsedir init values extracted from the FiveTitleTunes binary at $84E8..$84EA
  ...
  -- pulsedelay init values extracted from the FiveTitleTunes binary at $84E5..$84E7
...
--  not applicable in the cloned FiveTitleTunes codegen. SidgenFiveTitleTunesMain.lean
--  provides its own main using `five_title_tunesV3` from FiveTitleTunesV3.lean.)
