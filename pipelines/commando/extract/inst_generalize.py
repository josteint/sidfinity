...
def decode_instrument(inst: int, binary: bytes, load_addr: int,
                      base: int = INSTR_TABLE_BASE) -> InstrumentModel:
    ...
    family; only the table address differs per engine."""
