"""Command-line entry point for the DevilsGalop extract pipeline.

Usage:
    python -m pipelines.devils_galop.extract                   # alias for `cli`
    python -m pipelines.devils_galop.extract.cli               # explicit
    python -m pipelines.devils_galop.extract.cli 0,1,2         # all three music subtunes
    python -m pipelines.devils_galop.extract.cli -v 0          # subtune 0, debug-level logs
