;---------------------------------------
;SDI SPEEDPLAYER 2.1 (C)16/05/2014 SHAPE
...
REM~a4WFD  = 0  ;1 = IGNORE FE WF HOLD CMD
...
REM~a4VOFF = 0  ;1 = IGNORE VOICE ON/OFF
