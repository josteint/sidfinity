"""Dataclasses for MasterOfMagic's extracted (T, instruments, score) representation.

Mirrors Commando's shape with one MasterOfMagic-specific addition: each instrument
...
class Instrument:
    ...
    vibrato_scale: int = 0
    has_bit0: bool = False
    has_skydive: bool = False  # MasterOfMagic extension: fx_flags bit 1
