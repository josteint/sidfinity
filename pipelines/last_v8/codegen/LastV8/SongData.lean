...
def mv3I62 : USFInstrument := {
  initCtrl := ⟨65, by omega⟩
  initPwLo := ⟨227, by omega⟩
  initPwHi := ⟨9, by omega⟩
  ad := ⟨135, by omega⟩
  sr := ⟨136, by omega⟩
  initFreqMod := .normal
  ...
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨227, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 137, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .freqSlide, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I63 : USFInstrument := {
  initCtrl := ⟨137, by omega⟩
  initPwLo := ⟨64, by omega⟩
  initPwHi := ⟨7, by omega⟩
  ad := ⟨136, by omega⟩
  sr := ⟨152, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨137, by omega⟩]
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨160, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 155, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I64 : USFInstrument := {
  initCtrl := ⟨163, by omega⟩
  initPwLo := ⟨136, by omega⟩
  initPwHi := ⟨8, by omega⟩
  ad := ⟨164, by omega⟩
  sr := ⟨172, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨163, by omega⟩]
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨136, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 137, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
...
def mv3I65 : USFInstrument := {
  initCtrl := ⟨209, by omega⟩
  initPwLo := ⟨174, by omega⟩
  initPwHi := ⟨15, by omega⟩
  ad := ⟨37, by omega⟩
  sr := ⟨218, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨209, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨208, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨59, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 51, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .freqSlide, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I66 : USFInstrument := {
  initCtrl := ⟨9, by omega⟩
  initPwLo := ⟨150, by omega⟩
  initPwHi := ⟨5, by omega⟩
  ad := ⟨176, by omega⟩
  sr := ⟨142, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨9, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨8, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨186, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 165, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .freqSlide, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I67 : USFInstrument := {
  initCtrl := ⟨249, by omega⟩
  initPwLo := ⟨200, by omega⟩
  initPwHi := ⟨13, by omega⟩
  ad := ⟨4, by omega⟩
  sr := ⟨42, by omega⟩
  initFreqMod := .normal
  ...
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨87, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 77, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I68 : USFInstrument := {
  initCtrl := ⟨31, by omega⟩
  initPwLo := ⟨184, by omega⟩
  initPwHi := ⟨7, by omega⟩
  ad := ⟨166, by omega⟩
  sr := ⟨82, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨31, by omega⟩]
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨138, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 137, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
...
def mv3I69 : USFInstrument := {
  initCtrl := ⟨137, by omega⟩
  initPwLo := ⟨138, by omega⟩
  initPwHi := ⟨8, by omega⟩
  ad := ⟨138, by omega⟩
  sr := ⟨137, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨137, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨136, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨138, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 138, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .freqSlide, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I70 : USFInstrument := {
  initCtrl := ⟨139, by omega⟩
  initPwLo := ⟨136, by omega⟩
  initPwHi := ⟨10, by omega⟩
  ad := ⟨138, by omega⟩
  sr := ⟨137, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨139, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨138, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨138, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 138, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
...
def mv3I71 : USFInstrument := {
  ...
  sr := ⟨139, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨139, by omega⟩]
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨139, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 140, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I72 : USFInstrument := {
  initCtrl := ⟨1, by omega⟩
  initPwLo := ⟨139, by omega⟩
  ...
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨7, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := none
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.pwMod, .freqSlide, .arpeggio, .gateCheck]
...
def mv3I73 : USFInstrument := {
  ...
  sr := ⟨8, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨9, by omega⟩]
  waveLoop := 0
  waveStepEvery := 1
  pwMod := none
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 9, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I74 : USFInstrument := {
  ...
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨4, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := none
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
...
def mv3I75 : USFInstrument := {
  initCtrl := ⟨11, by omega⟩
  initPwLo := ⟨10, by omega⟩
  initPwHi := ⟨4, by omega⟩
  ad := ⟨4, by omega⟩
  sr := ⟨15, by omega⟩
  initFreqMod := .normal
  ...
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨16, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 16, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
...
def mv3I76 : USFInstrument := {
  ...
  sr := ⟨4, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨5, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨4, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨18, by omega⟩, stepEvery := 1, startDelay := 0 }
...
def mv3I77 : USFInstrument := {
  ...
  sr := ⟨2, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨3, by omega⟩]
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨2, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 3, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
...
def mv3I83 : USFInstrument := {
  ...
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨255, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 3, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
...
def mv3I84 : USFInstrument := {
  ...
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨1, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 2, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .freqSlide, .gateCheck]
...
def mv3I88 : USFInstrument := {
  ...
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨12, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 13, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
...
def mv3I89 : USFInstrument := {
  initCtrl := ⟨13, by omega⟩
  initPwLo := ⟨12, by omega⟩
  initPwHi := ⟨13, by omega⟩
  ad := ⟨13, by omega⟩
  sr := ⟨13, by omega⟩
  initFreqMod := .normal
  ...
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 15, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I90 : USFInstrument := {
  initCtrl := ⟨3, by omega⟩
  initPwLo := ⟨14, by omega⟩
  initPwHi := ⟨3, by omega⟩
  ad := ⟨3, by omega⟩
  sr := ⟨3, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨3, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨2, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨1, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 2, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
...
def mv3I91 : USFInstrument := {
  ...
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨3, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
...
def mv3I94 : USFInstrument := {
  ...
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨255, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 20, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .freqSlide, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I95 : USFInstrument := {
  initCtrl := ⟨21, by omega⟩
  initPwLo := ⟨254, by omega⟩
  initPwHi := ⟨4, by omega⟩
  ad := ⟨20, by omega⟩
  sr := ⟨20, by omega⟩
  initFreqMod := .normal
  ...
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨254, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 22, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I96 : USFInstrument := {
  initCtrl := ⟨255, by omega⟩
  initPwLo := ⟨254, by omega⟩
  initPwHi := ⟨9, by omega⟩
  ad := ⟨27, by omega⟩
  sr := ⟨27, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨255, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨254, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨27, by omega⟩, stepEvery := 1, startDelay := 0 }
...
def mv3I97 : USFInstrument := {
  initCtrl := ⟨255, by omega⟩
  initPwLo := ⟨27, by omega⟩
  initPwHi := ⟨10, by omega⟩
  ad := ⟨24, by omega⟩
  sr := ⟨254, by omega⟩
  initFreqMod := .normal
  ...
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨255, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 96, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .freqSlide, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I98 : USFInstrument := {
  ...
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨3, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 53, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I99 : USFInstrument := {
  ...
  sr := ⟨3, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨7, by omega⟩]
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨7, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 56, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I101 : USFInstrument := {
  ...
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨7, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 70, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I102 : USFInstrument := {
  initCtrl := ⟨131, by omega⟩
  initPwLo := ⟨3, by omega⟩
  initPwHi := ⟨9, by omega⟩
  ad := ⟨11, by omega⟩
  sr := ⟨0, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨131, by omega⟩]
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨241, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 156, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I103 : USFInstrument := {
  initCtrl := ⟨7, by omega⟩
  initPwLo := ⟨255, by omega⟩
  initPwHi := ⟨3, by omega⟩
  ad := ⟨69, by omega⟩
  sr := ⟨3, by omega⟩
  initFreqMod := .normal
  ...
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨7, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 70, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .gateCheck]
...
def mv3I105 : USFInstrument := {
  ...
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨131, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 69, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I106 : USFInstrument := {
  initCtrl := ⟨69, by omega⟩
  initPwLo := ⟨69, by omega⟩
  initPwHi := ⟨3, by omega⟩
  ad := ⟨7, by omega⟩
  sr := ⟨72, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨69, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨68, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨71, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 4, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .freqSlide, .arpeggio, .gateCheck]
...
def mv3I107 : USFInstrument := {
  initCtrl := ⟨69, by omega⟩
  initPwLo := ⟨67, by omega⟩
  initPwHi := ⟨3, by omega⟩
  ad := ⟨67, by omega⟩
  sr := ⟨135, by omega⟩
  initFreqMod := .normal
  ...
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .bidirectional ⟨50, by omega⟩ ⟨8, by omega⟩ ⟨14, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 10, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .freqSlide, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I108 : USFInstrument := {
  initCtrl := ⟨47, by omega⟩
  initPwLo := ⟨50, by omega⟩
  initPwHi := ⟨3, by omega⟩
  ad := ⟨135, by omega⟩
  sr := ⟨10, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨47, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨46, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨255, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 57, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .freqSlide, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I114 : USFInstrument := {
  ...
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨7, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 63, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := some { kind := .monotonic (-1), stepEvery := 1, startDelay := 9, stopAtZero := true }
  arpeggio := none
  effectOrder := [.vibrato, .pwMod, .freqSlide, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I115 : USFInstrument := {
  initCtrl := ⟨3, by omega⟩
  initPwLo := ⟨7, by omega⟩
  initPwHi := ⟨14, by omega⟩
  ad := ⟨59, by omega⟩
  sr := ⟨7, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨3, by omega⟩]
...
def mv3I116 : USFInstrument := {
  ...
  sr := ⟨62, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨163, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨162, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
...
def mv3I117 : USFInstrument := {
  ...
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨7, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 60, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def mv3I118 : USFInstrument := {
  ...
  sr := ⟨3, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨7, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨128, by omega⟩, ⟨6, by omega⟩]
  waveLoop := 4
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨7, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 63, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
...
def mv3I119 : USFInstrument := {
  initCtrl := ⟨59, by omega⟩
  initPwLo := ⟨163, by omega⟩
  initPwHi := ⟨7, by omega⟩
  ad := ⟨11, by omega⟩
  sr := ⟨57, by omega⟩
  initFreqMod := .normal
  waveformProgram := [⟨59, by omega⟩]
  waveLoop := 0
  waveStepEvery := 1
  pwMod := some { mode := .linear ⟨4, by omega⟩, stepEvery := 1, startDelay := 0 }
  vibrato := some { shape := .triangle, periodFrames := 8, semitoneShift := 132, onsetFrames := 6, rampUpFrames := 0, unipolar := true }
  freqSlide := none
  arpeggio := some { intervals := [0, 12], stepEvery := 1, phaseSource := .global, startDelay := 0 }
  effectOrder := [.vibrato, .pwMod, .arpeggio, .gateCheck]
  release := { framesBeforeEnd := 3, zeroAdsr := true, noRelease := false }
...
def last_v8V3 : USFSong := {
  freqTable := last_v8V3FreqTable
  instruments := [mv3I0, mv3I1, mv3I2, mv3I3, mv3I4, mv3I5, mv3I6, mv3I7, mv3I8, mv3I9, mv3I10, mv3I11, mv3I12, mv3I13, mv3I14, mv3I15, mv3I16, mv3I17, mv3I18, mv3I19, mv3I20, mv3I21, mv3I22, mv3I23, mv3I24, mv3I25, mv3I26, mv3I27, mv3I28, mv3I29, mv3I30, mv3I31, mv3I32, mv3I33, mv3I34, mv3I35, mv3I36, mv3I37, mv3I38, mv3I39, mv3I40, mv3I41, mv3I42, mv3I43, mv3I44, mv3I45, mv3I46, mv3I47, mv3I48, mv3I49, mv3I50, mv3I51, mv3I52, mv3I53, mv3I54, mv3I55, mv3I56, mv3I57, mv3I58, mv3I59, mv3I60, mv3I61, mv3I62, mv3I63, mv3I64, mv3I65, mv3I66, mv3I67, mv3I68, mv3I69, mv3I70, mv3I71, mv3I72, mv3I73, mv3I74, mv3I75, mv3I76, mv3I77, mv3I78, mv3I79, mv3I80, mv3I81, mv3I82, mv3I83, mv3I84, mv3I85, mv3I86, mv3I87, mv3I88, mv3I89, mv3I90, mv3I91, mv3I92, mv3I93, mv3I94, mv3I95, mv3I96, mv3I97, mv3I98, mv3I99, mv3I100, mv3I101, mv3I102, mv3I103, mv3I104, mv3I105, mv3I106, mv3I107, mv3I108, mv3I109, mv3I110, mv3I111, mv3I112, mv3I113, mv3I114, mv3I115, mv3I116, mv3I117, mv3I118, mv3I119, mv3I120]
