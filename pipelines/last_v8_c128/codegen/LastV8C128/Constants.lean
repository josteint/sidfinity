/-
Named constants used by LastV8C128.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. LastV8C128 uses 1 (vs Commando's 2) because LastV8C128
