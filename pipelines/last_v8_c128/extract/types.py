"""Dataclasses for LastV8C128's extracted (T, instruments, score) representation.

Mirrors Commando's shape with one LastV8C128-specific addition: each instrument
...
class Instrument:
    ...
    vibrato_scale: int = 0
    has_bit0: bool = False
    has_skydive: bool = False  # LastV8C128 extension: fx_flags bit 1
