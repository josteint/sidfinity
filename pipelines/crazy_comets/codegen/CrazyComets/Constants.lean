/-
Named constants used by CrazyComets.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. CrazyComets uses 1 (vs Commando's 2) because CrazyComets
