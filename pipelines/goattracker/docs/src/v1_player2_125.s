...
;บMusicroutine 11.2 by Lasse ”rni, September 2001.                            บ
;บWith sound effect support                                                    บ
...
mt_nextpatt:    ldy mt_chnsongptr,x
...
mt_endpatt:     sta mt_chnpattptr,x
                ldy mt_chncommand,x
                lda mt_chnnote,x              ;Sound effect playing?
                bmi mt_rest
                lda mt_temp3
...
mt_loadpulse:   lda mt_chnpulse,x
mt_loadpulse2:  sta $d402,x
                sta $d403,x
...
mt_cmddonothing:lda mt_chnnote,x
                bpl mt_nextchn
                jmp mt_dosfx
...
mt_setsustain:  ldy mt_chnnote,x
                bmi mt_cmddonothing
                sta $d406,x
                bpl mt_nextchn
...
mt_dosfx:       and #$7f
                tay
                lda mt_chnfreqlo,x                 ;Sound effect data pointer
                sta mt_temp1
                lda mt_chnfreqhi,x
                sta mt_temp2
                cpy #$03
                ...
                inc mt_chnnote,x
                lda #$00
                sta mt_chnpulsedir,x            ;To prevent ADSR init
                sta mt_chnwavetbl,x             ;To prevent wavetable exec.
                sta mt_chnwave,x
mt_dosfx_hardrestart:
                sta $d404,x
                sta $d405,x
                sta $d406,x
mt_dosfx_done:  jmp mt_nextchn

mt_dosfx_initdone:
                lda mt_chnwave,x              ;Sound effect delay?
...
mt_dosfx_noend: cmp #$e0                      ;Set delay?
                ...
                ldy mt_temp3
                iny
                lda (mt_temp1),y              ;Then take a look at the coming
...
mt_dosfx_nowavechange:
                tya
                ora #$80
                sta mt_chnnote,x              ;Store changed index
                ldy #$00
