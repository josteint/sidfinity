/-
Named constants used by ThingOnASpring.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. ThingOnASpring uses 1 (vs Commando's 2) because ThingOnASpring
