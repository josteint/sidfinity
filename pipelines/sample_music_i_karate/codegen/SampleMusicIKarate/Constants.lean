/-
Named constants used by SampleMusicIKarate.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. SampleMusicIKarate uses 1 (vs Commando's 2) because SampleMusicIKarate
