/-
Named constants used by OneManAndHisDroid.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. OneManAndHisDroid uses 1 (vs Commando's 2) because OneManAndHisDroid
