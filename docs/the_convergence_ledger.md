...
- CANONICAL: STATIC opcode probe (read the patched instruction itself; never
  ...
  to read-next-byte garbage — 27th occ). 28 occurrences (28th: the negative-transpose ADC immediate — canon
