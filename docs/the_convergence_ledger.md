...
- CANONICAL: STATIC opcode probe (read the patched instruction itself; never
  ...
  the neighbour's PW). 25 occurrences — the full entry catalogues every
  known wedge.
