...
- CANONICAL: STATIC opcode probe (read the patched instruction itself; never
  ...
  to read-next-byte garbage — 27th occ). 27 occurrences — the full entry
  catalogues every known wedge.
