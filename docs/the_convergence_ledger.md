...
- CANONICAL: STATIC opcode probe (read the patched instruction itself; never
  ...
  to a patch of that same immediate (cymbal ctrl $81→$02, 26th occ). 26
  occurrences — the full entry catalogues every known wedge.
