# SID `init` semantics — a research report
...
`docs/usf_representation_principle.md` (which I re-read in full for
this report), is:
...
- `/home/jtr/sidfinity/docs/usf_format.md` — current USF v2/v3 init
  block design.
- `/home/jtr/sidfinity/docs/usf_representation_principle.md` —
