...
- **~~HARD BOUNDARY~~ → RESOLVED — off-table reads that sonify the ABSOLUTE
  ...
  **SUPERSEDED FOR NORM CARRIERS (2026-07-28, live-signal phase 4 —
  ...
  placement is irrelevant. Boundary that REMAINS: a walk CONTINUING
  into unstated cells (soft-note continuation past the stated
  reachability, Deprave_7_tune_3's label drift of 2) still diverges —
  the reachability model doesn't cover continuation walks.
