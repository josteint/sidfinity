...
- **12th occurrence (2026-07-21) — the MULTI-SID RELOCATION MISS (COMPOSER
  ...
  frame (localize per chip, C28). Two carriers now ⇒ the role-tagged
  emitter sites are worth building. Census over all 10,676 DMC members: 19 multi-SID headers, 8
...
- **Status:** CANONICALIZED (12 occurrences: DMC family-1 rounds
