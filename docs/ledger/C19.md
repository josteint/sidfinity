...
- **22nd occurrence (round 117, 2026-07-24) — $FF track-loop handler
  ...
  2 carriers: Second partial→FULL; My_Firsty was FULL with the wrap PAST
  its verify window (the C32 past-window-latent class — the param makes it
  correct there too), re-verifies FULL.
