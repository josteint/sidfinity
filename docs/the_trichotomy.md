...
an EMPIRICAL claim; that file is its evidentiary basis (split out of
this file 2026-07-18; load it when revising the trichotomy or when the
spec-level detail matters). This file is the shorter synthesis for the
design call.
