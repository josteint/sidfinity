...
The exclusion data also flows into `hvsc84.db` via
`tools/build_sid_db.py` (columns `excluded` BOOL + `exclusion_reason`
TEXT) so queries like "how many SIDs are excluded, and why?" work
