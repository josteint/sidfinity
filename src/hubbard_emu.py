...
Usage:
    python3 src/hubbard_emu.py hvsc85/MUSICIANS/H/Hubbard_Rob/Commando.sid [song]

Verification:
    python3 src/hubbard_emu.py --verify hvsc85/MUSICIANS/H/Hubbard_Rob/Commando.sid
"""
