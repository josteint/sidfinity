...
|---|---|---|---|
| downslide | bit 0 | **Rule 1 COLLAPSE** with `freq_slide` | confirmed via PC trace + V1-only writelog diff on inst 6 (downslide-only) in subtune 1 frames 225-234. Writes match write-for-write. |
