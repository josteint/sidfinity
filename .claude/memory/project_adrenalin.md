...
- FIXED (fc25d4e): pos-87 was actually fx3-bit-2 AUTO-ARP (engine A $7D9C):
  ...
  instruction-sequence exact; divergence 87→89. NEXT: pos 89 = vol/filter ($D418/$D416) write
...
- ✅ SUB 0 INSTRUCTION-SEQUENCE EXACT (2026-06-08): two more ketchup fixes finished it.
  ...
  siddump-frame shorter); instruction-sequence exact by Mode-1 overlap standard. REMAINING:
...
- `init_style='fc_clear_sweep'` knob (commit a1bbba2) emits engine A's $7AE2
  init sweep. Adrenalin sub-0 init now instruction-sequence exact (full-flat pos 0..50); first
