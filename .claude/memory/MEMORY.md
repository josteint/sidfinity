...
- [Basic_Program family](project_basic_program.md) — 524 RSID-BASIC tunes on #85 (engine IS the BASIC+KERNAL ROM); trace-lift → USF round-trip. Stored 458 FULL (226 NF / 232 legacy); **re-census 2026-08-11**: +36 verified-FULL awaiting write (→494/524, 94.3%); NF ladder = order_conflict 81 → grid_collision ~49 (reader) → missing_sig ~29 (reader, glide sigs). METHOD: census a bucket for a shared lever.
