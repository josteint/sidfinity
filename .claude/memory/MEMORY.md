...
- [DMC migration](project_dmc.md) — THE FOCUS ENGINE (10,676 SIDs; largest family). V4 f1 **closeout 5296/5401 FULL (98.1%) + r107-112 gains (Ed×4, Chwat, Real_Hardcore, a0ff-tail ×7) = 5309** (closeout batch + mass-write post-r106, 2026-07-23; corpus synced, audit 9/9; r107+ gains not yet mass-written). Full 2SID/3SID (C27/C28) + compilation support incl. HETEROGENEOUS ([[project_dmc_compilations]]). **92-round history + every lever + methodology live in project_dmc.md — READ IT FIRST** (do NOT expand this line; new rounds → topic file). Re-verify any stale wide batch before picking.
