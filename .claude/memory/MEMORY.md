...
- [Digi-Organizer](project_digi_organizer.md) — first parametric-digi family (`digi{}` schema, volume_4bit): **29/39 standalone FULL cycle-strict** (verdicts CURRENT 2026-08-29 night); residue = 6 driver singles + sphere phase-slip pair + 2 named oddballs, then the 92 music-paired members. READ IT first.
