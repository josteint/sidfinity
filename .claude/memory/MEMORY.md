...
- [DMC migration](project_dmc.md) — THE FOCUS ENGINE (10,676 SIDs; largest family). V4 f1 **5329/5401 FULL (98.7%) + 72 partial + 0 error** (r127 2026-07-28, C37 save-state resume +2 after phase-4's +3; corpus last mass-written post-r112 — the r113-r126 gains/carriers await the next sync; NB Lane_Crazy subs 1-5 found drifted, pre-existing C20 palimpsest). Full 2SID/3SID (C27/C28) + compilation support incl. HETEROGENEOUS ([[project_dmc_compilations]]). **Round history + every lever + methodology live in project_dmc.md — READ IT FIRST** (do NOT expand this line; new rounds → topic file). Re-verify any stale wide batch before picking.
