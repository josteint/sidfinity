...
- [Digi-Organizer](project_digi_organizer.md) — first parametric-digi family (`digi{}` schema, volume_4bit): **1 FULL cycle-strict (Heavy-Beat)** of 131 carriers; next lever = driver parametrization → the 39 standalone members. READ IT first.
