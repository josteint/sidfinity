...
- [Digi-Organizer](project_digi_organizer.md) — first parametric-digi family (`digi{}` schema, volume_4bit): **30/39 standalone FULL cycle-strict** (verdicts CURRENT 2026-08-29 late); residue = 4 cycle-phase partials + 5 named unsupported (all decoded), then the 92 music-paired members. READ IT first.
