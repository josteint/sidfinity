...
- [Digi-Organizer](project_digi_organizer.md) — first parametric-digi family (`digi{}` schema, volume_4bit): **21/39 standalone FULL cycle-strict, 0 partial** (verdicts CURRENT 2026-08-29); residue = 18 unprobed driver shapes, then the 92 music-paired members. READ IT first.
