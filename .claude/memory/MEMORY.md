...
- [DMC migration](project_dmc.md) — THE FOCUS ENGINE (10,758 SIDs on #85; largest family). **f1 5,445/5,445 FULL (100%)** · **f2 2,924/2,924 (100%) — FAMILY-2 CLOSED 2026-08-21** (15 FULL landed that day; the final trio — Conversion, Witchs_Birthday, Just_11 — fell to ONE lever, the shipped f2 $FF loop-to-N immediate the factory never read, C9 10th occ). f1 5,445/5,445 + f2 2,924/2,924 = the whole DMC v4 space FULL. ⚠ resync debt: run the f2 batch + mass-write (vib_inc/dead-cargo/loop-imm carriers' stored artifacts stale, new FULLs unstored). Full 2SID/3SID (C27/C28) + compilations incl. HETEROGENEOUS ([[project_dmc_compilations]]). **READ project_dmc.md FIRST** — round history, every lever, methodology (newest-first); do NOT expand this line.
