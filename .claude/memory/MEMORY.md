...
- [DMC migration](project_dmc.md) — THE FOCUS ENGINE (10,676 SIDs; largest family). V4 f1 **5338/5401 FULL (98.8%) + 63 partial + 0 error** (r128c 2026-07-29; corpus MASS-WRITTEN + audited same day — phase-5 sync done, WT/SIG_OLDFORM levers retired; 4 drifted ex-FULLs incl. Lane_Crazy orphan-removed per C20). Full 2SID/3SID (C27/C28) + compilation support incl. HETEROGENEOUS ([[project_dmc_compilations]]). **Round history + every lever + methodology live in project_dmc.md — READ IT FIRST** (do NOT expand this line; new rounds → topic file). Re-verify any stale wide batch before picking.
