...
- [Basic_Program family](project_basic_program.md) — 524 RSID-BASIC tunes on #85 (engine IS the BASIC+KERNAL ROM); trace-lift → USF round-trip. **493/524 (94.1%) FULL stored** (2026-08-11: +35 written; 1 removed as round-trip-unstable). NF ladder: order_conflict 81 (writer, sections-as-patterns design) → the reader buckets are ~89% a REPRESENTATION GAP (multi-frame spread chord setups) after the 2026-08-11 reader fix (~11% converted). METHOD: census a bucket for a shared lever.
