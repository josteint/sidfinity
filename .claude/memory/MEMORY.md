...
- [DMC migration](project_dmc.md) — THE FOCUS ENGINE (10,676 SIDs). V4 family-1 **4795/5401 FULL (88.8%, round 23)**; family-2 2413/2889 (83.5%); V5 fam-3/5 1088/1495; fam-4 in progress. Residue ~401 = positional + in_table drift + $1720-2 unmappable + tail. LESSON: a "regressing" correct fix usually hits a STALE baseline/batch-flake/suboptimal-path FULL — re-baseline vs a FRESH single-member build ([[feedback_convergence_ledger]] C20). Per-round history + methodology in topic file — READ IT first.
