...
- [Basic_Program family](project_basic_program.md) — 524 RSID-BASIC tunes on #85 (engine IS the BASIC+KERNAL ROM); trace-lift → USF round-trip. **493/524 (94.1%) FULL stored; NF adoption 304/493 (62%)** after sections-as-patterns + the backtracking decl-grammar parser (2026-08-11 — the spread-chord "gap" dissolved: the decls were the grammar all along, ledger C17). Remaining legacy 175: interleaved >8-section orders, verify-diverge value-level tail (~56, uncensused), writer misc, vibrato tail. METHOD: census a bucket for a shared lever.
