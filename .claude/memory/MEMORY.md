...
- [GoatTracker family](project_goattracker.md) — 2nd-largest (8,670). **Active: V1** (original 1.x, NOT GT2). Extract + composer built; wide batch **168/1387 FULL** — verdicts CURRENT (full re-batch 2026-08-31: 1387/1387 identical, 0 status changes); re-run THROUGH the stored `.usf`; wired into regression.py. Detail in topic file — READ IT first.
