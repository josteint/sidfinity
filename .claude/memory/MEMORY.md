...
- [Basic_Program family](project_basic_program.md) — 524 RSID-BASIC tunes on #85 (engine IS the BASIC+KERNAL ROM); trace-lift → USF round-trip. **493/524 (94.1%) FULL stored; NF adoption 282/493 (57%)** after sections-as-patterns shipped 2026-08-11 (+35 converts, 25 multi-section). Remaining legacy: the multi-frame spread-chord REPRESENTATION GAP (reader buckets' bulk), interleaved >8-section orders, misc tails. METHOD: census a bucket for a shared lever.
