...
- [Music_Assembler — next family](project_music_assembler_target.md) — NOT STARTED. Largest un-migrated family with research done (6,351 SIDs, `engine_docs` OK) = CLAUDE.md's designated next family. Also blocks `Freespace_2075` (a DMC member whose relocated sub-players are MA).
