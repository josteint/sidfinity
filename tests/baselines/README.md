...
- `commando_original_writelog.txt` — `siddump --writelog --force-rsid
  --duration 30 --raw` of `hvsc85/MUSICIANS/H/Hubbard_Rob/Commando.sid`.
...
```
tools/siddump hvsc85/MUSICIANS/H/Hubbard_Rob/Commando.sid \
...
```
python3 src/writelog_diff.py hvsc85/MUSICIANS/H/Hubbard_Rob/Commando.sid <rebuild.sid>
```
