/-
Named constants used by MasterOfMagic.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. MasterOfMagic uses 1 (vs Commando's 2) because MasterOfMagic
