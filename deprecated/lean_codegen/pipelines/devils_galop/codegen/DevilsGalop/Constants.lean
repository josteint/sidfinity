/-
Named constants used by DevilsGalop.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. DevilsGalop uses 1 (vs Commando's 2) because DevilsGalop
