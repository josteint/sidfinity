/-
Named constants used by HunterPatrol.Codegen. Pulled out of Codegen.lean so the
...
/-- Hard-restart threshold. HunterPatrol uses 1 (vs Commando's 2) because HunterPatrol
