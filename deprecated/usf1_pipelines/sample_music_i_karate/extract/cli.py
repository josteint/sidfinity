...
Usage:
    ...
    python -m pipelines.sample_music_i_karate.extract.cli               # explicit
    python -m pipelines.sample_music_i_karate.extract.cli 0,1,2         # all three music subtunes
    python -m pipelines.sample_music_i_karate.extract.cli -v 0          # subtune 0, debug-level logs
